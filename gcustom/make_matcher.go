...
func formatObject(object interface{}, indent ...uint) string {
	indentation := uint(0)
	if len(indent) > 0 {
...
matchFunc must return (bool, error) and take a single argument.  If you want to perform type-checking yourself pass in a matchFunc of type `func(actual interface{}) (bool, error)`.  If you want to only operate on a specific type, pass in `func(actual DesiredType) (bool, error)`; MakeMatcher will take care of checking typues for you and notifying the user if they use the matcher with an invalid type.
...
*/
func MakeMatcher(matchFunc interface{}, args ...interface{}) CustomGomegaMatcher {
	...
	var finalMatchFunc func(actual interface{}) (bool, error)
	if t.In(0) == interfaceType {
		finalMatchFunc = matchFunc.(func(actual interface{}) (bool, error))
	} else {
		...
		finalMatchFunc = reflect.MakeFunc(reflect.TypeOf(finalMatchFunc),
			...
			}).Interface().(func(actual interface{}) (bool, error))
	}
...
type CustomGomegaMatcher struct {
	...
	customFailureMessage        func(actual interface{}) string
	customNegatedFailureMessage func(actual interface{}) string
}
...
Would generate a failure message that looks like:
	...
	to have widget named sprocker:
		<formatted sprocket>
*/
func (c CustomGomegaMatcher) WithTemplate(templ string, data ...interface{}) CustomGomegaMatcher {
...
*/
func (c CustomGomegaMatcher) WithPrecompiledTemplate(templ *template.Template, data ...interface{}) CustomGomegaMatcher {
...
*/
func (c CustomGomegaMatcher) WithTemplateData(data interface{}) CustomGomegaMatcher {
	c.templateData = data
	return c
}

// Match runs the passed-in match func and satisfies the GomegaMatcher interface
func (c CustomGomegaMatcher) Match(actual interface{}) (bool, error) {
...
func (c CustomGomegaMatcher) FailureMessage(actual interface{}) string {
...
func (c CustomGomegaMatcher) NegatedFailureMessage(actual interface{}) string {
...
func (c CustomGomegaMatcher) renderTemplateMessage(actual interface{}, isFailure bool) string {
